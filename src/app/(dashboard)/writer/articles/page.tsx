...
export const metadata: Metadata = {
  title: "Artikel Saya | SelesainAja Writer",
};
...
export default async function WriterArticlesPage({
  ...
  // Fetch articles based on query, status, AND AUTHOR ID
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-slate-800">Artikel Saya</h2>
          <p className="text-slate-500">Kelola draft dan artikel yang Anda tulis.</p>
        </div>
