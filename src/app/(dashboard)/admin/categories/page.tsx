...
export const metadata: Metadata = {
  title: "Kategori | SelesainAja Admin",
};
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-slate-800">Kategori</h2>
          <p className="text-slate-500">Kelola kategori untuk artikel blog.</p>
        </div>
